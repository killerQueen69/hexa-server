...
const envSchema = z.object({
  ...
  RELAY_COMMAND_TIMEOUT_MS: z.coerce.number().int().min(1000).max(30000).default(6000),
  RELAY_COMMAND_STATE_VERIFY_WINDOW_MS: z.coerce.number().int().min(0).max(10000).default(1200),
  RELAY_COMMAND_STATE_VERIFY_POLL_MS: z.coerce.number().int().min(50).max(2000).default(120),
